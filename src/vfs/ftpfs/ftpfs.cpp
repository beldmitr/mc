    ...
    if (ftpfs_get_reply (me, ftp_super->sock, reply_string, sizeof (reply_string) - 1) == COMPLETE)
    {
        ...
        case CONTINUE:
            ...
            if (code == CONTINUE)
            {
                ...
                op = input_dialog (p, _("Account:"), History::MC_HISTORY_FTPFS_ACCOUNT, "",
...
vfs_init_ftpfs (void)
{
    ...
    vfs_init_subclass (&ftpfs_subclass, "ftpfs", static_cast<vfs_flags_t>(VFSF_NOLINKS | VFSF_REMOTE | VFSF_USETMP), "ftp");
