...
WDialog* Learn::learn_dlg;
const char* Learn::learn_title = N_("Learn keys");

Learn::learnkey_t* Learn::learnkeys = nullptr;
int Learn::learn_total;
int Learn::learnok;
gboolean Learn::learnchanged = FALSE;

void Learn::learn_keys()
{
...
void Learn::learn_save()
{
    int i;
    char *section;
    gboolean profile_changed = FALSE;

    section = g_strconcat ("terminal:", std::getenv ("TERM"), (char *) nullptr);
...
void Learn::learn_done()
{
    dlg_destroy(learn_dlg);
    repaint_screen ();
}

void Learn::init_learn()
{
    WGroup *g;
...
cb_ret_t Learn::learn_callback(Widget * w, Widget * sender, widget_msg_t msg, int parm, void *data)
{
    switch(msg)
    {
        case MSG_KEY:
...
gboolean Learn::learn_check_key(int c)
{
    int i;
...
gboolean Learn::learn_move(gboolean right)
{
    int i, totalcols;
...
int Learn::learn_button(WButton * button, int action)
{
    WDialog *d;
    char *seq;
